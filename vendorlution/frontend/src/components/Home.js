    ...
    <main className='mt-4'>
      ...
      <div className='row mb-4'>
       ...
       {/*End Latest Products*/}
        ...
        {/*Popular Categories */}
        <h3>Popular Categories <a href = '#' className='float-end btn btn-sm btn-dark '><Link to="/categories">View All Categories</Link><i class="fa-solid fa-arrow-right-long "></i></a></h3>  
      <div className='row mb-4'>
         {/*Category Box*/}
      ...
      <div className='row mb-4'>
       ...
       {/*Ratings & Reviews*/}
        <div id="carouselExampleIndicators" className="carousel slide my-4 border bg-dark text-white p-4" data-bs-ride="true">
            ...
            <div className="carousel-item active">
              ...
              <figure>
                ...
                <figcaption className="blockquote-footer text-center">
                  ...
                  <i className='fa fa-star text-warning'></i>
                  <i className='fa fa-star text-warning'></i>
                  <cite title="Source Title">Cutomer Name</cite>
                </figcaption>
              </figure>
