    ...
    <nav className="navbar navbar-light bg-white border-bottom sticky-top">
      ...
      <div className="offcanvas offcanvas-start" id="mainNav">
        ...
        <div className="offcanvas-body">
          ...
          {/* Buyer section - only show if authenticated */}
          {isAuthenticated && (
            <>
          ...
          {/* Vendor My Shop dropdown - only show if authenticated */}
          {isAuthenticated && (
            <>
              <div
          ...
          {/* Show login/register links in offcanvas if not authenticated */}
          {!isAuthenticated && (
            <div className="list-group">
              <Link to="/customer/login" className="list-group-item list-group-item-action">
                <i className="fa fa-sign-in me-2"></i> Sign In
              </Link>
              <Link to="/customer/register" className="list-group-item list-group-item-action">
